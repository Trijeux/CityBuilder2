#include "maths/vec2u.h"

#include <gtest/gtest.h>


struct Vec2uOperationFixture :
	public ::testing::TestWithParam<std::pair<core::maths::Vec2u, core::maths::Vec2u>>
{

};

TEST_P(Vec2uOperationFixture, Add)
{
	auto [v1, v2] = GetParam();
...
TEST_P(Vec2uOperationFixture, Sub)
{
	auto [v1, v2] = GetParam();
	const auto result = v1 - v2;
	EXPECT_EQ(result.x, v1.x - v2.x);
...
TEST_P(Vec2uOperationFixture, Dot)
{
	auto [v1, v2] = GetParam();
	const auto result = core::maths::Vec2u::Dot(v1, v2);
	EXPECT_EQ(result, v1.x * v2.x + v1.y * v2.y);
}

TEST_P(Vec2uOperationFixture, Multi)
{
	auto [v1, v2] = GetParam();
...
TEST_P(Vec2uOperationFixture, Div)
{
	auto [v1, v2] = GetParam();
	if (v2.x != 0 || v2.y != 0)
	{
...
TEST_P(Vec2uOperationFixture, Perpendicular)
{
	auto [v1, v2] = GetParam();
	const auto p1 = v1.Perpendicular();
	const auto p2 = v2.Perpendicular();
	EXPECT_EQ(core::maths::Vec2u::Dot(v1, p1), 0);
	EXPECT_EQ(core::maths::Vec2u::Dot(v2, p2), 0);

	const auto r1 = v1.Perpendicular2();
	const auto r2 = v2.Perpendicular2();
	EXPECT_EQ(core::maths::Vec2u::Dot(v1, r1), 0);
	EXPECT_EQ(core::maths::Vec2u::Dot(v2, r2), 0);
}

TEST_P(Vec2uOperationFixture, Lerp)
{
	auto [v1, t] = GetParam();
	const auto result = core::maths::Vec2u::Lerp(v1, t.x);
	EXPECT_FLOAT_EQ(result, v1.x * (1 - t.x) + v1.y * t.x);
}

INSTANTIATE_TEST_SUITE_P(AllNumbers,
	Vec2uOperationFixture,
	testing::Values(
		std::pair{ core::maths::Vec2u{1,3}, core::maths::Vec2u{2,4} },
		std::pair{ core::maths::Vec2u{10, 15}, core::maths::Vec2u{25, 35} },
		std::pair{ core::maths::Vec2u{0, 0}, core::maths::Vec2u{0, 0} },
		std::pair{ core::maths::Vec2u{}, core::maths::Vec2u{} },
		std::pair{ core::maths::Vec2u{1, 2}, core::maths::Vec2u{} },
		std::pair{ core::maths::Vec2u{}, core::maths::Vec2u{1, 2} }
	)
);
